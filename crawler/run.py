...
def main():
    ...
    # The Slack digest item covers entries indexed in the last 7 days; store.py
    # builds its one-line summary (count + omics fields) from the entries.
